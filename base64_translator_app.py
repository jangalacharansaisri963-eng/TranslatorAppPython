...
class Base64TerminalTranslator(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("Terminal Console - Base64 Core")
    ...
    def execute_terminal_line(self, event=None):
        ...
        self.terminal_display.insert("end", f"translator@base64:~$ {raw_cmd}\n")
