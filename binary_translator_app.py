...
class BinaryTerminalTranslator(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("Terminal Console - Binary Core")
    ...
    def execute_terminal_line(self, event=None):
        ...
        self.terminal_display.insert("end", f"translator@binary:~$ {raw_cmd}\n")
