...
class SpanishTerminalTranslator(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("Terminal Console - Spanish Core")
        ...
        ctk.CTkLabel(self.input_frame, text="translator@spanish:~$ ", font=ctk.CTkFont(family="Consolas", size=13, weight="bold"), text_color="#00FF33").pack(side="left")
    ...
    def execute_terminal_line(self, event=None):
        ...
        self.terminal_display.insert("end", f"translator@spanish:~$ {raw_cmd}\n")
